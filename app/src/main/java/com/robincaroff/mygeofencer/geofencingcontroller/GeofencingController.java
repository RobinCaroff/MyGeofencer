...
import com.robincaroff.mygeofencer.services.GeofenceTransitionsIntentService;
import com.robincaroff.mygeofencer.utils.Constants;
import com.robincaroff.mygeofencer.utils.GeofenceErrorMessages;
...
public class GeofencingController implements GeofencingControllerProtocol, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, ResultCallback<Status> {

    protected static final String TAG = GeofencingController.class.getSimpleName();
    ...
    /**
     * Used to know if we should update the registered geofences list.
     */
    private boolean mGeofencesRegistrationUpdateNeeded;
    ...
    public void updateGeofenceList(List<MyGeofence> geofences) {
        ...
        if(mGoogleApiClient.isConnected()) {
            ...
            mGeofencesRegistrationUpdateNeeded = true;
        }
    }

    private void updateRegisteredGeofences() {
        removeGeofences();
        addGeofences();
        mGeofencesRegistrationUpdateNeeded = false;
    }
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        if(mGeofencesRegistrationUpdateNeeded) {
            updateRegisteredGeofences();
        }
    }
